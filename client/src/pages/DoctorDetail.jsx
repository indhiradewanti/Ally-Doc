			...
			<div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
				...
				>
					<div class="p-4 md:p-12 text-center lg:text-left">
						...
						<h1 class="text-3xl font-bold pt-8 lg:pt-0 caslon">
							{detailDoctor.username}
						</h1>
						<div class="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-green-500 opacity-25"></div>
						<p class="pt-4 text-base font-bold flex items-center justify-center lg:justify-start">
							<svg
								class="h-4 fill-current text-brown pr-4"
						...
						{/* {detailDoctor.status === "online" ? (
							<button
								onClick={toChat}
								className="btn btn-outline1 hidden sm:inline-block text-white transition-transform transform hover:scale-110 hover:text-indigo-700 w-32 mt-5 vogue"
							>
								Chat Now
							</button>
						) : (
				...
				<div class="w-full lg:w-2/5 ">
					<img
						alt="doctors"
						src={detailDoctor.photo}
						class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block mask mask-square"
					/>
				</div>
			</div>
		</div>
