              ...
              <div className="p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 ">
                <div className="flex flex-row">
                  <div className="flex flex-col">
                    <img alt="mountain" className="w-45 rounded-full ring-2 ring-white border-4 border-yellow-500" src="https://picsum.photos/seed/picsum/200" />
                  </div>
                  <div className="flex flex-col justify-center ml-5">
                    <h4 className="text-xl font-semibold mb-2">Nama dokter</h4>
                    <p className="text-gray-800 font-semibold mb-3">status : online</p>
                ...
                <div className="flex mt-8 mb-5  flex-row justify-around">
                  <div className="flex flex-col">
                    <div className="border border-yellow-500 text-grey px-5 py-2">2 tahun</div>
                  </div>
                  <div className="flex flex-col">
                    <button className="bg-green-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded-full w-40">CHAT</button>
                  </div>
                </div>
              </div>
              <div className="p-4 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 ">
