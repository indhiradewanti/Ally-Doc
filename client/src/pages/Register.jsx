        ...
        <div className="flex justify-center self-center z-10 w-1/3 my-14">
          <div className="p-12 bg-white mx-auto rounded-2xl w-full">
            ...
            <form className="space-y-5">
              ...
              <div class="space-y-2">
      <label className="mb-5 text-sm font-medium text-gray-700 tracking-wide" for="grid-state">
        Gender
      </label>
      <div className="relative">
        <select className="block appearance-none w-full border border-gray-300 rounded-lg text-gray-700 py-3 px-4 pr-8 leading-tight focus:border-green-400 focus:outline-none focus:bg-white" id="grid-state">
          <option>Male</option>
