		...
		<div>
			<div className="w-full carousel">
				<div id="slide1" className="relative w-full carousel-item">
					<img
						src="https://demo.joomlashine.com/joomla-templates/jsn_hospital/pro/hospital/images/joomlashine/sample/homepage/background-img.jpg"
						alt="background"
						className="w-full"
					/>
					<div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
						...
						<div className="text-left absolute text-gray-700 ml-20">
							<h1 className="font-bold text-left text-4xl she -mt-10">
								WELCOME TO
							</h1>
							<h1 className="font-bold text-left text-4xl she mt-5">
								ALLYDOC
							</h1>
				...
				<div id="slide2" className="relative w-full carousel-item">
					<img
						src="https://demo.joomlashine.com/joomla-templates/jsn_hospital/pro/hospital/images/joomlashine/sample/homepage/s2.jpg"
						alt="background1"
						className="w-full"
					/>
					<div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
						...
						<div className="mx-4 text-center text-white">
							<h1 className="font-bold text-6xl cigra">
								FRIENDLY DOCTORS
							</h1>
							<h2 className=" text-4xl caslon">
				...
				<div id="slide3" className="relative w-full carousel-item">
					<img
						src="https://demo.joomlashine.com/joomla-templates/jsn_hospital/pro/hospital/images/joomlashine/sample/homepage/s1.jpg"
						alt="background3"
						className="w-full"
					/>
					<div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
					...
					<div className="flex flex-wrap">
						<div className="p-3 -mb-20 lg:w-1/3">
							<div className="h-full bg-brown bg-opacity-75 px-8 pt-16 rounded-lg overflow-hidden text-center relative">
								<h1 className="title-font font-bold text-4xl text-white my-auto meg">
									Why Choose AllyDoc?
								</h1>
								<p className="leading-relaxed my-auto mt-10 text-lg">
									AllyDoc is a Telemedicine platform where
									users can get medical advice from doctors.
									We stringently verify our online doctors to
									ensure they are fully licensed so that the
									care we provide will always be of the
									highest quality. Team-AllyDoc consists of
									eminent doctors, researchers and programmers
									who work round the clock to innovate, create
									and implement the best web technologies for
									the use of doctors, users and hospitals.
								</p>
							</div>
						</div>
						<div className="p-2 lg:h-80 lg:w-1/3 mt-20">
							<div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
								...
								<p className="leading-relaxed mb-3 text-lg">
									Our Live Chat feature allows you to “chat”
									with our qualified and fully registered
									Doctors anywhere
								</p>
							</div>
						</div>
						<div className="p-2 lg:h-80 lg:w-1/3 mt-20 ">
							<div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
								...
								<p className="leading-relaxed mt-8 mb-3">
									Advice from the best doctors and top medical
									experts
								</p>
							</div>
						</div>
			...
			<div className="max-w-xl mx-auto text-center mt-40">
				...
				<p className="font-light text-gray-600 mb-6 leading-relaxed">
					you can choose whatever services you like
				</p>
			</div>
			<section className="text-gray-600 body-font">
						...
						<div className="lg:w-1/3 sm:w-1/2 p-4">
							<div className="flex relative bd-nude border-2">
								...
								<div className="px-8 py-10 relative z-10 w-full border-4 bd-nude1 bg-nude1 opacity-0 hover:opacity-100">
									<h2 className="tracking-widest text-xl title-font font-medium text-white mb-10">
										CHATTING
									</h2>
									<p className="leading-relaxed text-white">
										Start chatting with our healthcare
										professionals and they will provide you
										with advice to your medical condition .
									</p>
								</div>
							</div>
						</div>
						<div className="lg:w-1/3 sm:w-1/2 p-4">
							<div className="flex relative bd-nude border-2">
								...
								<div className="px-8 py-10 relative z-10 w-full border-4 bd-nude1 bg-nude1 opacity-0 hover:opacity-100">
									...
									<p className="leading-relaxed text-white">
										Start calling with our healthcare
										professionals and they will provide you
										with advices for your medical
										conditions.
									</p>
								</div>
							</div>
						...
						<div className="lg:w-1/3 sm:w-1/2 p-4">
							<div className="flex flex-wrap relative bd-nude border-2">
								...
								<div className="px-8 py-10 relative z-10 w-full border-4 bd-nude1 bg-nude1 opacity-0 hover:opacity-100">
									...
									<p className="leading-relaxed text-white">
										Start video calling with our healthcare
										professionals and they will provide you
										with advice to your medical condition .
									</p>
								</div>
