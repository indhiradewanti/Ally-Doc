      ...
      <form onSubmit={handleSubmit}>
        <div className="min-w-screen min-h-screen items-center justify-center px-5 pb-10 pt-16 max-ww content-center">
          <div className="w-full mx-auto rounded-lg new-bg p-5 text-gray-700 shadow-2xl">
            ...
            <div className="mb-10">
              <h1 className="text-center font-bold text-xl uppercase meg">Secure payment info</h1>
            </div>
            <div className="mb-3 flex -mx-2">
              <div className="px-2">
                <label htmlFor="type1" className="flex items-center cursor-pointer">
                  <input type="radio" className="form-radio h-5 w-5 text-gray-500" name="type" id="type1" />
